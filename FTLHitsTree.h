...
#define DATA_CLASS_TABLE                                                \
  ...
  DATA(vector<float>,   recHits_time1_uncalibrated)                                     \
  DATA(vector<float>,   recHits_time2_uncalibrated)                                     \
  DATA(vector<double>,   recHits_eta_uncalibrated)                                     \
  DATA(vector<double>,   recHits_phi_uncalibrated)                                     \
  DATA(vector<float>, recHits_matched_with_uncalibrated)                                      \
